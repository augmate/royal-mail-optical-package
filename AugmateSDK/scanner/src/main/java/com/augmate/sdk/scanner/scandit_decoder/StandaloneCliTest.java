...
//    LD_LIBRARY_PATH=~/android-ndk/platforms/android-19/arch-x86/usr/lib/ ~/Downloads/jdk1.7.0_67/bin/java -Djava.library.path=../../../libs/x86 -cp . com.augmate.sdk.scanner.scandit_decoder.StandaloneCliTest
